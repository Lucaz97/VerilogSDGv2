...
class Source(Node):
    ...
    def __init__(self, name, description, lineno=0, id_num=0):
        self.lineno = lineno
        if id_num == 0:
            Node.curr_id_num +=1
            self.id_num = Node.curr_id_num
        else:
            self.id_num = id_num
        self.name = name
...
class Description(Node):
    ...
    def __init__(self, definitions, lineno=0, id_num=0):
        self.lineno = lineno
        if id_num == 0:
            Node.curr_id_num +=1
            self.id_num = Node.curr_id_num
...
class ModuleDef(Node):
    ...
    def __init__(self, name, paramlist, portlist, items, default_nettype='wire', lineno=0, id_num=0):
        self.lineno = lineno
        if id_num == 0:
            Node.curr_id_num +=1
            self.id_num = Node.curr_id_num
...
class Paramlist(Node):
    ...
    def __init__(self, params, lineno=0, id_num=0):
        self.lineno = lineno
        if id_num == 0:
            Node.curr_id_num +=1
            self.id_num = Node.curr_id_num
...
class Portlist(Node):
    ...
    def __init__(self, ports, lineno=0, id_num=0):
        self.lineno = lineno
        if id_num == 0:
            Node.curr_id_num +=1
            self.id_num = Node.curr_id_num
...
class Port(Node):
    ...
    def __init__(self, name, width, dimensions, type, lineno=0, id_num=0):
        self.lineno = lineno
        if id_num == 0:
            Node.curr_id_num +=1
            self.id_num = Node.curr_id_num
...
class Width(Node):
    ...
    def __init__(self, msb, lsb, lineno=0, id_num=0):
        self.lineno = lineno
        if id_num == 0:
            Node.curr_id_num +=1
            self.id_num = Node.curr_id_num
...
class Dimensions(Node):
    ...
    def __init__(self, lengths, lineno=0, id_num=0):
        self.lineno = lineno
        if id_num == 0:
            Node.curr_id_num +=1
            self.id_num = Node.curr_id_num
...
class Identifier(Node):
    ...
    def __init__(self, name, scope=None, lineno=0, id_num=0):
        self.lineno = lineno
        if id_num == 0:
            Node.curr_id_num +=1
            self.id_num = Node.curr_id_num
...
class Value(Node):
    ...
    def __init__(self, value, lineno=0, id_num=0):
        self.lineno = lineno
        if id_num == 0:
            Node.curr_id_num +=1
            self.id_num = Node.curr_id_num
...
class Constant(Value):
    ...
    def __repr__(self):
        return str(self.value) +"lineno: "+ str(self.lineno)

    def __eq__(self, other):
        if not isinstance(other, type(self)):
            return False

        return self.lineno == other.lineno and self.id_num == other.id_num
...
class Variable(Value):
    ...
    def __init__(self, name, width=None, signed=False, dimensions=None, lineno=0, id_num=0):
        self.lineno = lineno
        if id_num == 0:
            Node.curr_id_num +=1
            self.id_num = Node.curr_id_num
...
class Ioport(Node):
    ...
    def __init__(self, first, second=None, lineno=0, id_num=0):
        self.lineno = lineno
        if id_num == 0:
            Node.curr_id_num +=1
            self.id_num = Node.curr_id_num
...
class Parameter(Node):
    ...
    def __init__(self, name, value, width=None, signed=False, lineno=0, id_num=0):
        self.lineno = lineno
        if id_num == 0:
            Node.curr_id_num +=1
            self.id_num = Node.curr_id_num
...
class Decl(Node):
    ...
    def __init__(self, list, lineno=0, id_num=0):
        self.lineno = lineno
        if id_num == 0:
            Node.curr_id_num +=1
            self.id_num = Node.curr_id_num
...
class Repeat(Node):
    ...
    def __init__(self, value, times, lineno=0, id_num=0):
        self.lineno = lineno
        if id_num == 0:
            Node.curr_id_num +=1
            self.id_num = Node.curr_id_num
...
class Partselect(Node):
    ...
    def __init__(self, var, msb, lsb, lineno=0, id_num=0):
        self.lineno = lineno
        if id_num == 0:
            Node.curr_id_num +=1
            self.id_num = Node.curr_id_num
...
class Pointer(Node):
    ...
    def __init__(self, var, ptr, lineno=0, id_num=0):
        self.lineno = lineno
        if id_num == 0:
            Node.curr_id_num +=1
            self.id_num = Node.curr_id_num
...
class Lvalue(Node):
    ...
    def __init__(self, var, lineno=0, id_num=0):
        self.lineno = lineno
        if id_num == 0:
            Node.curr_id_num +=1
            self.id_num = Node.curr_id_num
...
class Operator(Node):
    ...
    def __init__(self, left, right, lineno=0, id_num=0):
        self.lineno = lineno
        if id_num == 0:
            Node.curr_id_num +=1
            self.id_num = Node.curr_id_num
    ...
    def __repr__(self):
        ...
        for c in self.children():
            ret += ' ' + c.__repr__()
        ret += ') lineno:' + str(self.lineno) +"id_num:"+str(self.id_num)
        return ret
...
class UnaryOperator(Operator):
    ...
    def __init__(self, right, lineno=0, id_num=0):
        self.lineno = lineno
        if id_num == 0:
            Node.curr_id_num +=1
            self.id_num = Node.curr_id_num
...
class Cond(Operator):
    ...
    def __init__(self, cond, true_value, false_value, lineno=0, id_num=0):
        self.lineno = lineno
        if id_num == 0:
            Node.curr_id_num +=1
            self.id_num = Node.curr_id_num
...
class Assign(Node):
    ...
    def __init__(self, left, right, ldelay=None, rdelay=None, lineno=0, id_num=0):
        self.lineno = lineno
        if id_num == 0:
            Node.curr_id_num +=1
            self.id_num = Node.curr_id_num
...
class Always(Node):
    ...
    def __init__(self, sens_list, statement, lineno=0, id_num=0):
        self.lineno = lineno
        if id_num == 0:
            Node.curr_id_num +=1
            self.id_num = Node.curr_id_num
...
class Sens(Node):
    ...
    def __init__(self, sig, type='posedge', lineno=0, id_num=0):
        self.lineno = lineno
        if id_num == 0:
            Node.curr_id_num +=1
            self.id_num = Node.curr_id_num
...
class IfStatement(Node):
    ...
    def __init__(self, cond, true_statement, false_statement, lineno=0, id_num=0):
        self.lineno = lineno
        if id_num == 0:
            Node.curr_id_num +=1
            self.id_num = Node.curr_id_num
...
class ForStatement(Node):
    ...
    def __init__(self, pre, cond, post, statement, lineno=0, id_num=0):
        self.lineno = lineno
        if id_num == 0:
            Node.curr_id_num +=1
            self.id_num = Node.curr_id_num
...
class WhileStatement(Node):
    ...
    def __init__(self, cond, statement, lineno=0, id_num=0):
        self.lineno = lineno
        if id_num == 0:
            Node.curr_id_num +=1
            self.id_num = Node.curr_id_num
...
class CaseStatement(Node):
    ...
    def __init__(self, comp, caselist, lineno=0, id_num=0):
        self.lineno = lineno
        if id_num == 0:
            Node.curr_id_num +=1
            self.id_num = Node.curr_id_num
...
class Block(Node):
    ...
    def __init__(self, statements, scope=None, lineno=0, id_num=0):
        self.lineno = lineno
        if id_num == 0:
            Node.curr_id_num +=1
            self.id_num = Node.curr_id_num
...
class Initial(Node):
    ...
    def __init__(self, statement, lineno=0, id_num=0):
        self.lineno = lineno
        if id_num == 0:
            Node.curr_id_num +=1
            self.id_num = Node.curr_id_num
...
class EventStatement(Node):
    ...
    def __init__(self, senslist, lineno=0, id_num=0):
        self.lineno = lineno
        if id_num == 0:
            Node.curr_id_num +=1
            self.id_num = Node.curr_id_num
...
class DelayStatement(Node):
    ...
    def __init__(self, delay, lineno=0, id_num=0):
        self.lineno = lineno
        if id_num == 0:
            Node.curr_id_num +=1
            self.id_num = Node.curr_id_num
...
class InstanceList(Node):
    ...
    def __init__(self, module, parameterlist, instances, lineno=0, id_num=0):
        self.lineno = lineno
        if id_num == 0:
            Node.curr_id_num +=1
            self.id_num = Node.curr_id_num
...
class Instance(Node):
    ...
    def __init__(self, module, name, portlist, parameterlist, array=None, lineno=0, id_num=0):
        self.lineno = lineno
        if id_num == 0:
            Node.curr_id_num +=1
            self.id_num = Node.curr_id_num
...
class ParamArg(Node):
    ...
    def __init__(self, paramname, argname, lineno=0, id_num=0):
        self.lineno = lineno
        if id_num == 0:
            Node.curr_id_num +=1
            self.id_num = Node.curr_id_num
...
class PortArg(Node):
    ...
    def __init__(self, portname, argname, lineno=0, id_num=0):
        self.lineno = lineno
        if id_num == 0:
            Node.curr_id_num +=1
            self.id_num = Node.curr_id_num
...
class Function(Node):
    ...
    def __init__(self, name, retwidth, statement, lineno=0, id_num=0):
        self.lineno = lineno
        if id_num == 0:
            Node.curr_id_num +=1
            self.id_num = Node.curr_id_num
...
class FunctionCall(Node):
    ...
    def __init__(self, name, args, lineno=0, id_num=0):
        self.lineno = lineno
        if id_num == 0:
            Node.curr_id_num +=1
            self.id_num = Node.curr_id_num
...
class Task(Node):
    ...
    def __init__(self, name, statement, lineno=0, id_num=0):
        self.lineno = lineno
        if id_num == 0:
            Node.curr_id_num +=1
            self.id_num = Node.curr_id_num
...
class GenerateStatement(Node):
    ...
    def __init__(self, items, lineno=0, id_num=0):
        self.lineno = lineno
        if id_num == 0:
            Node.curr_id_num +=1
            self.id_num = Node.curr_id_num
...
class SystemCall(Node):
    ...
    def __init__(self, syscall, args, lineno=0, id_num=0):
        self.lineno = lineno
        if id_num == 0:
            Node.curr_id_num +=1
            self.id_num = Node.curr_id_num
...
class IdentifierScopeLabel(Node):
    ...
    def __init__(self, name, loop=None, lineno=0, id_num=0):
        self.lineno = lineno
        if id_num == 0:
            Node.curr_id_num +=1
            self.id_num = Node.curr_id_num
...
class IdentifierScope(Node):
    ...
    def __init__(self, labellist, lineno=0, id_num=0):
        self.lineno = lineno
        if id_num == 0:
            Node.curr_id_num +=1
            self.id_num = Node.curr_id_num
...
class Pragma(Node):
    ...
    def __init__(self, entry, lineno=0, id_num=0):
        self.lineno = lineno
        if id_num == 0:
            Node.curr_id_num +=1
            self.id_num = Node.curr_id_num
...
class PragmaEntry(Node):
    ...
    def __init__(self, name, value=None, lineno=0, id_num=0):
        self.lineno = lineno
        if id_num == 0:
            Node.curr_id_num +=1
            self.id_num = Node.curr_id_num
...
class Disable(Node):
    ...
    def __init__(self, dest, lineno=0, id_num=0):
        self.lineno = lineno
        if id_num == 0:
            Node.curr_id_num +=1
            self.id_num = Node.curr_id_num
...
class EmbeddedCode(Node):
    ...
    def __init__(self, code, lineno=0, id_num=0):
        self.code = code
